...
class CustomButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Color? resolvedButtonColor = buttonColor ?? Color(AppColors().primary.c500);
    ...
    if (onlyContent && resolvedTextColor == Colors.white) {
      resolvedTextColor = Color(AppColors().primary.c500);
    }
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(8),
            border: isBorderedButton || !onlyContent
                ? Border.all(
                    width: 1,
                    color: AppColors().cDEE3E7,
                  )
                : null,
          ),
          child: Row(
            ...
            children: [
              if (prefixIcon != null) ...[
                HugeIcon(icon: prefixIcon!, color: resolvedTextColor!, size: 18),
                const Gap(4),
              ],
              Text(
                label,
                style: Theme.of(context).textTheme.bodyLarge?.copyWith(
                      ...
                      fontSize: onlyContent ? 14 : 16,
                    ),
              ),
              if (suffixIcon != null) ...[
                const Gap(4),
                HugeIcon(icon: suffixIcon!, color: resolvedTextColor!, size: 18),
              ],
            ],
          ),
        ),
